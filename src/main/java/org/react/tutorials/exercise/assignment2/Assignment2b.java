...
public class Assignment2b {
    ...
    private static final Logger log = LoggerFactory.getLogger(Assignment2b.class);
    ...
    public static void main(String[] args) {
        ...
        client.getStockMarketPrices()
                .map(Assignment2b::convertPriceToValue)
                .takeUntil(Assignment2b::isCutOffPrice)
                .map(Assignment2b::buyStock)
                .doOnComplete(() -> {
